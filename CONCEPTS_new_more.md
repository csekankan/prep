# Agentic AI — Complete Concept Reference (Beginner → Staff Engineer)

> Everything you need to go from zero to production-grade agentic systems.
> Read top to bottom once, then use as a reference.
> **New here?** This doc pairs well with GENAI_PYTHON_BACKEND_new_more.md's Section 0 for even more
> foundational vocabulary (tokens, embeddings, what an LLM API call is).
